...
internal interface IDistanceCalculator {
    ...
    /// target. See <see href="https://en.wikipedia.org/wiki/Levenshtein_distance">this article
    ...
    /// <returns>
    /// The edit distance between the given <paramref name="source"/> and <paramref name="target"/>
    /// strings.
    /// </returns>
